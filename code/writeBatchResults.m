% writeBatchResults outputs the results file with summary data from batch
% analysis. This is used to generate the excel results sheet.
%
...
function statsTable = writeBatchResults(file_pairs, colorModel, sampleresults)
    ...
    for i=1:numel(channel_names)
        channels{i} = channel_named(colorModel, channel_names{i});
    end
    ...
    % Header is in columnNames variable
