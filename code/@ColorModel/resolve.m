...
function CM=resolve(CM) % call after construction and configuration
    ...
    if TASBEConfig.isSet('calibration.overrideUnits')
        ...
        TASBESession.warn('TASBE:ColorModel','Warning: overriding units with specified k_ERF value of %d',k_ERF);
    else
    ...
    if TASBEConfig.isSet('calibration.overrideAutofluorescence')
        ...
        TASBESession.warn('TASBE:ColorModel','Warning: overriding autofluorescence model with specified values.');
    ...
    if TASBEConfig.isSet('calibration.overrideCompensation')
        ...
        TASBESession.warn('TASBE:ColorModel','Warning: overriding compensation model with specified values.');
    ...
    if TASBEConfig.isSet('calibration.overrideTranslation')
        ...
        TASBESession.warn('TASBE:ColorModel','Warning: overriding translation scaling with specified values.');
    else
